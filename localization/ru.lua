    ...
    descriptions = {
        Back = {
            ...
            b_cry_beta = {
                ...
                text = {
                    "{C:attention}Джокер{} и {C:attention} Расходный материал{}",
                    "слоты{C:attention}объеденены",
                    "{C:attention}Ностальгия{} заменяет Блайнд",
                    "обновляет Блайнд"
                },
            },
            b_cry_blank = {
            ...
            b_cry_CCD = {
                ...
                text = {
                    "Все карты такие же",
                    "{C:attention}случайный{} расход",
                },
            },
            b_cry_conveyor = {
                name = "Конвеейрная Колода",
                text = {
                    "Джокеры {C:attention}не{} могут перемешщаться",
                    "В начале раунда,",
                    "{C:attention}дублирует{} правого Джокера",
                    "and {C:attention}уничтожает{} левого Джокера",
                },
            },
            b_cry_critical = {
                name = "Критическая Колода",
                text = {
                    "После каждой сыгранной партии,",
                    "{C:green}#1# из 4{} шанс {X:dark_edition,C:white} ^2 {} Умножение",
                    "{C:green}#1# из 8{} шанс {X:dark_edition,C:white} ^0.5 {} Умножение",
                },
            },
            b_cry_encoded = {
                name = "Зашифрованная Колода",
                text = {
                    "Начните с {C:cry_code,T:j_cry_CodeJoker}Зашифрованного Джокера{}",
            ...
            b_cry_equilibrium = {
                ...
                text = {
                    "На всех картах есть",
                    "{C:attention}такая же вероятность{} как",
                    "появится в магазинах,",
                    "начать ран с",
                    "{C:attention,T:v_overstock_plus}Избыточным запасом",
                },
            },
            b_cry_glowing = {
        ...
        Blind = {
            ...
            bl_cry_lavender_loop = {
                ...
                text = {
                    "Требуется 1.25X раза больше очков  за каждый раунд",
                    "1.5 секунды требуется на раунд",
                },
            },
            bl_cry_obsidian_orb = {
