...
Блайнды ✅ (Проверены, новых в 0.5.2 нету)
Карты кода ✅ (Проверены, добавлены новые из 0.5.2)
...
return {
    descriptions = {
	    ...
	    b_cry_beige = {
                name = "Бежевая колода",
                text = {
                    "У {C:attention}Обычных{} джокеров",
                    "в {C:attention}четыре раза{} больше значения",
                },
            },
            b_cry_beta = {
	    ...
	    b_cry_bountiful = {
		name = "Обильная колода",
		text = {
                    "После {C:blue}игра{} или {C:red}сброса{},",
	    ...
	    b_cry_bountiful = {
		name = "Щедрая колода", -- ЕСЛИ Я ПРИДУМАЮ ПЕРЕВОД ЛУЧШЕ... заменить кттс
		text = {
        ...
        Blind = {
            ...
            bl_cry_clock = {
                name = "Часы",
                text = {
                    "Блайнд увеличивается на +0.1X за",
            ...
            bl_cry_sapphire_stamp = {
                ...
                text = {
                    ...
                    "случайной карты перед подсчетом очков",
                },
            },
            bl_cry_shackle = {
                name = "Кандалы 2.0",
            ...
            bl_cry_tax = {
                name = "Налог",
                text = {
                    "Количество очков за руку ограничены",
            ...
            bl_cry_trick = {
                name = "Хитрость",
                text = {
                    "После каждой раздачи переворачивайте все",
                    "карты лицом вверх, которые вы держите в руке",
                },
            },
            bl_cry_vermillion_virus = {
                name = "Вермиллион Вирус",
                text = {
        ...
        Code = {
            ...
            c_cry_delete = {
                name = "://DELETE",
                text = {
                    "{C:cry_code}Навсегда{} удаляет",
                    "{C:cry_code}выбранный{} предмет в лавке",
                    "{C:inactive,s:0.8}Выбранный предмет не появится снова в лавке",
                },
            },
            c_cry_divide = {
                name = "://DIVIDE",
                text = {
                    "{C:cry_code}Снижает вдвое{} все указанные цены",
                    "в текущей лавке",
                },
            },
            c_cry_exploit = {
            ...
            c_cry_hook = {
                ...
                text = {
                    ...
                    "становятся {C:cry_code}Соединенными",
                },
            },
            c_cry_machinecode = {
                name = "://MACHINECODE",
            ...
            c_cry_merge = {
                name = "://MERGE",
                text = {
                    "Объеденить выбранную {C:cry_code}расходуемую карту",
            ...
            c_cry_payload = {
                ...
                text = {
                    "Следующий блайнд",
                    "дает в {C:cry_code}X#1#{} раза больше процентов",
                },
            },
            c_cry_oboe = {
                name = "://OFFBYONE",
                text = {
                    "В следующем {C:cry_code}Бустер наборе{} будет",
            ...
            c_cry_reboot = {
                name = "://REBOOT",
                text = {
                    "Возвращает разыгранные {C:blue}Руки{} и {C:red}Сбросы{},",
                    "{C:cry_code}все{} карты в колоде",
                    "и набирает {C:cry_code}новую{} руку",
                },
            },
            c_cry_revert = {
                name = "://REVERT",
                text = {
                    "Установливает {C:cry_code}состояние игры{} в",
            ...
            c_cry_rework = {
                ...
                text = {
                    ...
                    "создает {C:cry_code}Переработка Тег{} с",
                    "{C:cry_code}улучшенной{} версией",
                    "{C:inactive,s:0.8}Порядок как в коллекции",
                },
            },
            c_cry_run = {
                name = "://RUN",
            ...
            c_cry_seed = {
                ...
                text = {
                    "Выберите джокера",
                    "или игральную карту",
                    "что бы те стали {C:cry_code}Подтасовным",
                },
            },
            c_cry_semicolon = {
                name = ";//",
                text = { 
		     "Завершает текущий не-Босс{C:cry_code}Блайнд{}", 
		     "{C:cry_code}без{} обналичивания" 
		},
            },
            c_cry_spaghetti = {
                name = "://SPAGHETTI",
                text = {
                    "Создает {C:cry_code}Глитч",
                    "Джокера с едой",
                },
            },
            c_cry_variable = {
                name = "://VARIABLE",
                text = {
                    "Преобразовать {C:cry_code}#1#{} выбранные карты",
            ...
            c_cry_ctrl_v = {
                ...
                text = {
                    ...
                    "игральной карты или расходуемой карты"
                },
            },
	    c_cry_patch = {
		name = "://PATCH",
		text = {
		     "Убирает все ослабления и стикеры",
		     "с видимых карт",
	    	},
	    },
	    c_cry_inst = {
		name = "://INSTANTIATE",
		text = {
		     "Вытяните с {C:attention}Рангом{} выбранной карты",
	             "и ещё одну с {C:attention}Мастью{} выбранной карты",
        ...
        Edition = {
		    ...
		    "другую карту",
                    "{C:inactive}(Пустая сторона может быть объединена",
		    "{C:inactive}с другой картой)",
                },
            },
            e_cry_glass = {
                name = "Хрупкий",
                ...
                text = {
                    ...
                    "{C:green}#1# к #2#{} шанс эта",
                    "карта не {C:red}уничтожится",
                    "при подсчете",
                },
            },
            e_cry_glitched = {
        ...
        Enhanced = {
            m_cry_echo = {
                ...
                text = {
                    "{C:green}#2# in #3#{} шанс",
                    "{C:attention}перезапустить{} #1# раз дополнительно",
                    "при подсчете",
                },
            },
        },
        Joker = {
            j_cry_altgoogol = {
                name = "Ностальгическая Гугол Плей Карточка",
                text = {
                    "Продайте эту карту, чтобы создать",
                    "{C:attention}2{} копии самого левого {C:attention}Джокера{}",
                    "{C:inactive,s:0.8}Не копирует Ностальгические Гугол Плей Карточки{}",
                },
            },
            j_cry_antennastoheaven = {
                name = "...КАК АНТЕННЫ ДО НЕБЕС", -- Wiki-accurate перевод :nerd:
                text = {
            ...
            j_cry_apjoker = {
                name = "Бронебойный Джокер", -- AP - Armor-piercing
            ...
            j_cry_astral_bottle = {
                ...
                text = {
                    "Продайте эту карту, чтобы применить {C:dark_edition}Астральный{}",
            ...
            j_cry_biggestm = {
                ...
                text = {
                    ...
                    "{C:inactive,s:0.8}не толстый, просто кость широкая.",
                },
            },
            j_cry_blender = {
                name = "Блендер",
	    ...
	    j_cry_blacklist = {
                name = "Чёрный список",
                text = {
                    "Если {C:attention}#1#{} находится в руке или сыгран,",
                    "устанавливает {C:chips}фишки{} и {C:mult}множ.{} на 0",
                    "{C:red,E:2}самоуничтожается{} если нету {C:attention}#1#{} в колоде",
